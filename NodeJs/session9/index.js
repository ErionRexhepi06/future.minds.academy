...
app.get('/suppliers/:id/products', (req, res) => {
    ...
    res.json({ message: 'Products for supplier retrieved successfully', products });
});
...
app.post('/products', (req, res) => {
    ...
    if (!name || price == null || !supplierId) {
        res.status(400).json({ message: 'Please provide name, price, and supplierId for the product.' });
        return;
    }
...
app.get('/suppliers', (req, res) => {
    res.json({ message: 'Suppliers retrieved successfully', suppliers: db.suppliers });
});
...
app.post('/suppliers', (req, res) => {
    ...
    if (!name || !phoneNumber || !location) {
        res.status(400).json({ message: 'Please provide name, phoneNumber, and location for the supplier.' });
        return;
    }
